...
public class TowerBuilder : MonoBehaviour
{
    ...
    private void SpawnPlatform(Platform platform, ref Vector3 spawmPosition, Transform parent)
    {
        Instantiate(platform, spawmPosition, Quaternion.Euler(0, Random.Range(0, 360), 0), parent);
        spawmPosition.y -= 1;
    }
